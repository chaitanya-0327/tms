...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=CHAITANYA\\SQLEXPRESS;Initial Catalog=training_management_system;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmailId, "UQ__employee__3FEF876764CEAC01")
                    .IsUnique();
            ...
            modelBuilder.Entity<Hr>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmailId, "UQ__hr__3FEF876753102CCF")
                    .IsUnique();
            ...
            modelBuilder.Entity<Manager>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmailId, "UQ__manager__3FEF8767667B53EE")
                    .IsUnique();
            ...
            modelBuilder.Entity<TrainingEnrolled>(entity =>
            {
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasConstraintName("FK__training___emplo__47DBAE45");

                entity.HasOne(d => d.Training)
                    .WithMany(p => p.TrainingEnrolleds)
                    .HasForeignKey(d => d.TrainingId)
                    .HasConstraintName("FK__training___train__46E78A0C");
            });
            ...
            modelBuilder.Entity<TrainingRequest>(entity =>
            {
                ...
                entity.HasOne(d => d.EmployeeEmailNavigation)
                    ...
                    .HasConstraintName("FK__training___emplo__66603565");

                entity.HasOne(d => d.Training)
                    .WithMany(p => p.TrainingRequests)
                    .HasForeignKey(d => d.TrainingId)
                    .HasConstraintName("FK__training___train__656C112C");
            });
